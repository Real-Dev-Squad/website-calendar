...
const Navbar = () => {
  ...
  return (
    <nav className="w-full md:w-52 flex flex-row md:flex-col h-auto md:h-screen justify-between  px-2 sm:px-4 py-2.5 border-solid border-2 border-stone-200 bg-stone-50 fixed bottom-0 md:static">
      <div className="basis-full">
        <ul className="flex flex-row md:flex-col  justify-evenly p-2 mt-0 md:mt-4 md:text-sm md:font-medium bg-stone-50">
          <li
            className="flex flex-col md:flex-row items-center mb-0 md:mb-8 cursor-pointer group"
            onClick={() => toggle(0)}
          >
          ...
          <li
            className="flex flex-col md:flex-row md:hidden  items-center mb-0 md:mb-8 cursor-pointer group"
            onClick={() => toggle(3)}
          >
      ...
      <div>
        <ul className="hidden md:flex flex-col p-2 mt-4 md:mt-0 md:text-sm md:font-medium md:border-0 bg-stone-50">
          <li
            className="flex items-center mb-0 md:mb-8 cursor-pointer group"
            onClick={() => toggle(3)}
          >
            <div className="h-5 w-5  group">
              <Cog6ToothIcon
