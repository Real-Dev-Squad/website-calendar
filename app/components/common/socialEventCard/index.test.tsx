...
import SocialEventCard from './index';

describe('SocialEventCard', () => {
  ...
  it('should render the number of attendees when there are more than one number of attendees', () => {
    const { getByText } = render(<SocialEventCard {...dummyevent2} />);
  ...
  it('should render the number of attendees when there are more than one number of attendees', () => {
    const { getByText } = render(<SocialEventCard {...dummyevent3} />);
